import svgPaths from "./svg-1jwajx8azv";
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Head">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[16px] relative w-full">
          ...
          <p className="flex-[1_0_0] font-['Pretendard_JP:SemiBold',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[16px] text-[rgba(0,0,0,0.88)]">정산 금액 수기 등록</p>
        </div>
      </div>
    </div>
  );
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[32px] items-center min-h-px min-w-px relative" data-name="Content">
      ...
      <p className="flex-[1_0_0] font-['Pretendard_JP:Regular',sans-serif] leading-[22px] min-h-px min-w-px not-italic relative text-[14px] text-[rgba(0,0,0,0.25)]">결제 ID 검색</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex font-['pretendard-jp-variable:medium',sans-serif] gap-[4px] items-center leading-[0] not-italic relative shrink-0 text-[14px] whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0 text-[rgba(0,0,0,0.65)]">
        <p className="leading-[22px]">결제일</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#f5222d]">
        <p className="leading-[22px]">*</p>
      </div>
...
function Component() {
  return (
    <div className="-translate-y-1/2 absolute bg-white content-stretch flex flex-col gap-[16px] h-[1080px] items-start left-0 top-1/2 w-[400px]" data-name="수기 조정 - 포인트 정산">
      <Cps />
      <Frame8 />
    </div>
  );
